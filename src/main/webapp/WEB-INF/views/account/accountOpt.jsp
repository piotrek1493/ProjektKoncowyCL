...
<div class="w3-main" style="margin-left:250px">
	...
	<h1 class="w3-text-teal">Account edition panel</h1>
	...
	<div class="w3-container w3-padding-16 w3-margin w3-col w3-card-4 w3-display-middle w3-theme-15" style="width:30%">
		<form:form method="post" modelAttribute="user">
			...
			<div class="w3-container w3-padding-16">
				...
				<form:input type="password" path="password" class="w3-input w3-theme-15" value="" />
				<form:errors path="password" cssClass="w3-text-red" element="div"/>
			</div>
			<div class="w3-center w3-section">
				<input type="submit" value="Edit" class="w3-btn w3-theme w3-large w3-margin" style="width: 30%">
			</div>
		</form:form>
		<a href="/delete">Delete your account</a></p>
	</div>
</div>
</body>
</html>